  ...
  const stats = [
    {
      ...
      bgColor: "bg-gradient-to-br from-violet-50 to-purple-100 dark:from-violet-900/20 dark:to-purple-900/20"
    },
    {
      title: "Total Users",
      value: users.length,
    ...
    <div className="space-y-8 p-6 bg-gray-50/50 dark:bg-slate-900 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          ...
          >
            ...
            <div className={`absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-r ${stat.color} rounded-full opacity-10 group-hover:opacity-20 transition-opacity duration-300`}></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-semibold text-slate-800 dark:text-white">Order Status Distribution</h3>
          </div>
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 className="text-xl font-semibold text-slate-800 dark:text-white">Recent Sales Trend</h3>
          </div>
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-xl font-semibold text-slate-800 dark:text-white">Recent Orders</h3>
        </div>
            ...
            recentOrders.map((order, index) => (
              ...
              >
                ...
                <div className="text-right">
                  <p className="text-slate-800 dark:text-white font-bold text-lg">₹{(order.total || 0).toLocaleString()}</p>
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${
                    order.status === 'Delivered' ? 'bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 dark:text-emerald-300 border-emerald-200 dark:border-emerald-800' :
                    order.status === 'Pending' ? 'bg-amber-50 dark:bg-amber-900/20 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-800' :
                    order.status === 'Cancelled' ? 'bg-rose-50 dark:bg-rose-900/20 text-rose-700 dark:text-rose-300 border-rose-200 dark:border-rose-800' :
