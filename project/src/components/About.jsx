      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">Our impact in the gaming community</p>
          </div>
  ...
  <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
      <div className="bg-white bg-opacity-10 rounded-lg p-6">
        <h3 className="text-2xl font-bold mb-3 text-purple-600">Accessibility</h3>
        <p className="text-purple-600">Making gaming accessible to everyone, everywhere</p>
      </div>
      <div className="bg-white bg-opacity-10 rounded-lg p-6">
        <h3 className="text-2xl font-bold mb-3 text-purple-600">Innovation</h3>
        <p className="text-purple-600">Constantly improving and innovating for our community</p>
      </div>
      <div className="bg-white bg-opacity-10 rounded-lg p-6">
        <h3 className="text-2xl font-bold mb-3 text-purple-600">Community</h3>
        <p className=" text-purple-600">Building a strong, supportive gaming community</p>
      </div>
    </div>
  </div>
</section>
